...
#previousCollection test
def prevCollTest(input, expectedOutput):
    ...
    pColl = pColl.replace('\n', ' ')
    print( "Previous Collection: " + pColl + " Expected Output: " + expectedOutput + " Test is: " + str(pColl == expectedOutput))
...
test_06_OutputPrevCollection = "London Market, Christie's, Sale Cat. 12 Dec. 1984, no. 128, ill.  on p. 25."
...
test_10_OutputPrevCollection = "Hope  coll. 266"
...
#Previous Collection tests
# prevCollTest(test_01_OutputCollection, test_01_OutputPrevCollection)
# prevCollTest(test_02_OutputCollection, test_02_OutputPrevCollection)
# prevCollTest(test_03_OutputCollection, test_03_OutputPrevCollection)
# prevCollTest(test_04_OutputCollection, test_04_OutputPrevCollection)
# prevCollTest(test_05_OutputCollection, test_05_OutputPrevCollection)
# prevCollTest(test_06_OutputCollection, test_06_OutputPrevCollection)
# prevCollTest(test_07_OutputCollection, test_07_OutputPrevCollection)
# prevCollTest(test_08_OutputCollection, test_08_OutputPrevCollection)
# prevCollTest(test_09_OutputCollection, test_09_OutputPrevCollection)
# prevCollTest(test_10_OutputCollection, test_10_OutputPrevCollection) #Does not pick up Museum, only collection within Museum
