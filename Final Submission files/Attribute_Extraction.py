...
Write_to_CSV("Part1.txt", "1", "AttributeExtraction_p1.csv", "plates_p1.csv")
Write_to_CSV("Part2.txt","2", "AttributeExtraction_p2.csv", "plates_p2.csv")
Write_to_CSV("Part3.txt","3", "AttributeExtraction_p3.csv", "plates_p3.csv")